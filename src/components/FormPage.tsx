 ...
 * un clavier qui s'ouvre au-dessus d'une feuille plafonnée à 90vh finissait
 * par masquer les boutons du bas. En page normale, le document défile avec
 * le clavier comme n'importe quel autre écran de l'appli.
 */
