...
export function MacroBars({ eaten, targets }: MacroBarsProps) {
  ...
  const rows = [
    { key: 'protein', label: t('macro.protein'), value: eaten.protein, goal: targets.protein, color: 'var(--protein)' },
    { key: 'carbs', label: t('macro.carbs'), value: eaten.carbs, goal: targets.carbs, color: 'var(--carbs)' },
    { key: 'fat', label: t('macro.fat'), value: eaten.fat, goal: targets.fat, color: 'var(--fat)' },
  ]
