...
const fr = {
  ...
  'chat.noKey': "Ajoutez votre clé API Google Gemini dans le profil pour activer l'assistant.",
  ...
  'profile.apiKey': 'Clé API Google Gemini',
  'profile.apiKeyHint':
    "Utilisée uniquement sur cet appareil, envoyée directement à Google pour l'assistant nutrition. Jamais incluse dans l'export. Clé gratuite sur aistudio.google.com.",
...
const pt: Dict = {
  ...
  'chat.noKey': 'Adicione sua chave de API do Google Gemini no perfil para ativar o assistente.',
  ...
  'profile.apiKey': 'Chave de API do Google Gemini',
  'profile.apiKeyHint':
    'Usada apenas neste aparelho, enviada diretamente ao Google para o assistente de nutrição. Nunca incluída na exportação. Chave gratuita em aistudio.google.com.',
...
const es: Dict = {
  ...
  'chat.noKey': 'Añade tu clave de API de Google Gemini en el perfil para activar el asistente.',
  ...
  'profile.apiKey': 'Clave de API de Google Gemini',
  'profile.apiKeyHint':
    'Se usa solo en este dispositivo, enviada directamente a Google para el asistente de nutrición. Nunca incluida en la exportación. Clave gratuita en aistudio.google.com.',
  'add.deleteFood': 'Eliminar este alimento',
...
const en: Dict = {
  ...
  'chat.noKey': 'Add your Google Gemini API key in the profile to enable the assistant.',
  ...
  'profile.apiKey': 'Google Gemini API key',
  'profile.apiKeyHint':
    'Used only on this device, sent directly to Google for the nutrition assistant. Never included in the export. Free key at aistudio.google.com.',
...
const it: Dict = {
  ...
  'chat.noKey': "Aggiungi la tua chiave API Google Gemini nel profilo per attivare l'assistente.",
  ...
  'profile.apiKey': 'Chiave API Google Gemini',
  'profile.apiKeyHint':
    "Usata solo su questo dispositivo, inviata direttamente a Google per l'assistente nutrizionale. Mai inclusa nell'esportazione. Chiave gratuita su aistudio.google.com.",
