...
const fr = {
  ...
  'weight.chartHint': "Enregistre au moins deux pesées pour voir la courbe d'évolution.",
...
const pt: Dict = {
  ...
  'weight.chartHint': 'Registe pelo menos duas pesagens para ver a curva de evolução.',
...
const es: Dict = {
  ...
  'weight.chartHint': 'Registra al menos dos pesajes para ver la curva de evolución.',
...
const en: Dict = {
  ...
  'weight.trend': 'Trend',
  'weight.chartHint': 'Log at least two weigh-ins to see the trend line.',
...
const it: Dict = {
  ...
  'weight.chartHint': "Registra almeno due pesate per vedere l'andamento.",
